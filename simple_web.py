...
<div class="modal-overlay" id="modal-gen" onclick="if(event.target===this)closeModals()">
  <div class="modal">
    ...
    <div class="form-grid">
      ...
      <div class="input-group"><label>Generated</label><div style="display:flex;gap:8px"><input type="text" id="gen-result" readonly style="font-family:var(--font-mono)"><button class="btn sm" onclick="copyText(E('gen-result').value)">📋</button></div></div>
