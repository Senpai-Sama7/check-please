"""Cerebras provider — GET /v1/models with Bearer token (OpenAI-compatible)."""
...
class CerebrasProvider(Provider):
    ...
    env_patterns: ClassVar[list[re.Pattern[str]]] = [re.compile(r"^CEREBRAS_API_KEY(_ALT\d+)?$")]
    key_format: ClassVar[re.Pattern[str]] = re.compile(r"^csk-[a-z0-9]{40,}$")
